...
function Home() {
  ...
  return (
    <StyledRWD>
      ...
      <StyledReservation ref={reservationRef}>
        <StyledDark />
        ...
        <StyledContainer>
          ...
          <StyledMenuList>
            ...
            <StyledFlex $wrap={"wrap"} $add={"margin:-10px;"}>
              <StyledMenuItem className="col-12 col-md-6 col-lg-3">
      ...
      <StyledFooterInfo>© Copyright 2020 All rights reserved</StyledFooterInfo>
    </StyledRWD>
  );
}
